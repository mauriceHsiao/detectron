...
class labelme2coco(object):
    ...
    def annotation(self,points,label,num):
        ...
        # area
        run_len_encoding = mask.frPyObjects(annotation['segmentation'],height, width)
        area_mask = mask.area(run_len_encoding)
        annotation['area'] = area_mask.tolist()[0]
        #print(annotation)
        return annotation
    ...
    def save_json(self):
        ...
        try:
            ...
            # indent=4 更加美观显示
            print("{} file load.".format(num+1))
            print("{} save sucessfull.".format(args['file']))
        except :
            print("json file save fail.")
...
labelme2coco(labelme_json,'./'+args['file'])
